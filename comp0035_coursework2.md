...
From the 9 techniques listed in BAKOK, the following techniques will be used in the project. (BABOK, 2015) 

1. **Brainstorming**: The group will have a discussion and share ideas to derive creative ideas for the problem. It is applied to the project because the project group has 5 people from diverse background and they are willing and engaged in the participation.
2. **Interview**: Through conversations with potential users, capture the requirements from question and answer. It helps the team to discover some hidden requirements like non-verbal aspects in a simple and direct way. Since the project group is full of experienced product manager and developers, no prior training needed for interview.
3. **Prototyping**: Throughout the life cycle of the product development, capture requirements from each iterations. It can perfectly incorporate with Scrum. For each sprint, the requirements will be evaluated with user stories and validate it in the next sprint. It has smaller costs because it can have early feedback and aviod infeasible solutions. Since the project group is full of experienced product manager and developers, they are equiped with technology knowledge and able to solve complex case through iterations.
4. **Requirements Workshops**: Elicit requirements from creative ideas generated in a structured session with users and stakeholders. The workshop can be finished in a short period of time and costs less than interviews. This will perfectly incorporate with Scrum and finish the sprint on time. In addition, because the project group is full of experienced product manager and developers, they are able to conduct the workshop successfully.
5. **Survey/Questionnaire**: Collect information about the products and requirements after many users or stakeholders finish the written questions in a short period of time. This will perfectly incorporate with Scrum and finish the sprint on time. Closed and open questions can provide quantitative and qualitative insights.

However, the following techniques cannot be used in the project.
1. **Document Analysis**: Analyse some documents like market studies and existing solutions to have some ideas about the product. However, it cannot be applied because currently there is no any volcano apps in the market which has similar features. In addition, it's hard to find any market studies because the number of target users and market are quite small. Due to the nature of Scrum, each sprint should be finished in 1-4 weeks. There is no enough time for the group to work on the time-consuming analysis.
2. **Focus Group**: Through the interactions with a group of users, capture their needs and perferences. However, the interactive session costs a lot in sceduling the session, especially during the pandemic. Since the volcano app is a new product and there is no existing solutions in the market, therefore focus group is not useful to identify the requirements. This technique can be considered after a few sprint for a more completed volcano app.
3. **Interface Analysis**: It used for the analysis on the interface interactions between solutions and components of solutions. However, the volcano app is a new product and there is no existing solutions in the market, therefore interface analysis is not applicable for now but could be useful in the future sprints.
4. **Observation**: Capture the requirements when the users are using existing process. However, this technique is time-consuming and can only improve the current process.

### Requirement specification method
User story is used to specify the requirements beacasue the project methodlogy selected is a combination of Scrum and CRISP-DM. User story is an important part in Agile method. (Abdollazadeh, 2021)
1. For each sprint in the Scrum, stories in the sprint help the team to focus on the real needs of the end users and have a better understanding.
2. The teams can work together and come out with creative solutions

### Prioritisation method
**100 points method**: Considering the project methodology selected is a combination of Scrum and CRISP-DM. Scrum requires each sprint to be finished in very short period of time, normally 1-4 weeks. It is essential to save time and iterate from the feedback. 100 points method is selected to measure the priority for different requirements with quantitative values in simple and direct way. In addition, the project group are 5 sensior developers and product managers, they will provide professional evaluation on the requirements. It is not necessary to include other prioritisation method because they can make good justification based on their own experience. They know what requirements are likely to be essential to the app aand they will give more points for higher priority.
...
<table class="MsoTableGrid" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse;border:none;mso-border-alt:solid windowtext .5pt;
 ...
 <tbody><tr style="mso-yfti-irow:0;mso-yfti-firstrow:yes;height:4.25pt">
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:4.25pt">
  <p class="MsoNormal">Number<o:p></o:p></p>
  </td>
  <td width="378" valign="top" style="width:10.0cm;border:solid windowtext 1.0pt;
  border-left:none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
  solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:4.25pt">
  <p class="MsoNormal">User story<o:p></o:p></p>
  </td>
  <td width="387" valign="top" style="width:290.55pt;border:solid windowtext 1.0pt;
  border-left:none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
  solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:4.25pt">
  <p class="MsoNormal">Acceptance Criteria<o:p></o:p></p>
  </td>
  <td width="113" valign="top" style="width:3.0cm;border:solid windowtext 1.0pt;
  border-left:none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
  solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:4.25pt">
  <p class="MsoNormal">Functional/non-functional<o:p></o:p></p>
  </td>
 ...
 <tr style="mso-yfti-irow:1;height:4.25pt">
  ...
  <p class="MsoNormal">US01<o:p></o:p></p>
  </td>
  <td width="378" valign="top" style="width:10.0cm;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:4.25pt">
  <p class="MsoNormal">As the residents lived near a volcano, I want to receive
  the eruption alerts on my IOS or Android phone so that I can receive that at
  any time.<o:p></o:p></p>
  </td>
  <td width="387" valign="top" style="width:290.55pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:4.25pt">
  <p class="MsoListParagraphCxSpFirst" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l5 level1 lfo8"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  ...
  </span></span></span><!--[endif]-->Able to access and download through major app
  stores like Apple store and Google store<o:p></o:p></p>
  ...
  </span></span></span><!--[endif]-->Support recent 5 versions of Android and IOS<o:p></o:p></p>
  </td>
  <td width="113" valign="top" style="width:3.0cm;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:4.25pt">
  <p class="MsoNormal">Non-functional<o:p></o:p></p>
  </td>
 ...
 <tr style="mso-yfti-irow:2;height:4.25pt">
  ...
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:4.25pt">
  <p class="MsoNormal">US02<o:p></o:p></p>
  </td>
  <td width="378" valign="top" style="width:10.0cm;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:4.25pt">
  <p class="MsoNormal">As the scientists, I want the app to support Chrome, Firefox,
  and Safari so that I can use the app at any browsers.<o:p></o:p></p>
  </td>
  <td width="387" valign="top" style="width:290.55pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:4.25pt">
  <p class="MsoListParagraphCxSpFirst" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l7 level1 lfo2"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin"><span style="mso-list:Ignore">1.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;
  </span></span></span><!--[endif]-->Support recent 5 versions of major browsers<o:p></o:p></p>
  <p class="MsoListParagraphCxSpLast" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l7 level1 lfo2"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin"><span style="mso-list:Ignore">2.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;
  </span></span></span><!--[endif]-->Comply with cookie policy<o:p></o:p></p>
  </td>
  <td width="113" valign="top" style="width:3.0cm;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
 ...
 <tr style="mso-yfti-irow:3;height:4.25pt">
  ...
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:4.25pt">
  <p class="MsoNormal">US03<o:p></o:p></p>
  </td>
  <td width="378" valign="top" style="width:10.0cm;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:4.25pt">
  <p class="MsoNormal">As the residents who interested in volcano, I want to search
  the volcano that lived with so that I can learn about its history and other
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:4.25pt">
  <p class="MsoListParagraphCxSpFirst" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l4 level1 lfo4"><!--[if !supportLists]--><span lang="EN-US" style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:
  minor-latin;mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
  mso-ansi-language:EN-US"><span style="mso-list:Ignore">1.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span><!--[endif]--><span lang="EN-US" style="mso-ansi-language:EN-US">Able to search according to volcano
  name or number<o:p></o:p></span></p>
  <p class="MsoListParagraphCxSpMiddle" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l4 level1 lfo4"><!--[if !supportLists]--><span lang="EN-US" style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:
  minor-latin;mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
  mso-ansi-language:EN-US"><span style="mso-list:Ignore">2.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span><!--[endif]--><span lang="EN-US" style="mso-ansi-language:EN-US">Return results within 2 seconds<o:p></o:p></span></p>
  <p class="MsoListParagraphCxSpMiddle" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l4 level1 lfo4"><!--[if !supportLists]--><span lang="EN-US" style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:
  minor-latin;mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
  mso-ansi-language:EN-US"><span style="mso-list:Ignore">3.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span><!--[endif]-->Data
  is retrieved from volcano data repository using an authenticated API.<span lang="EN-US" style="mso-ansi-language:EN-US"><o:p></o:p></span></p>
  <p class="MsoListParagraphCxSpLast" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l4 level1 lfo4"><!--[if !supportLists]--><span lang="EN-US" style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:
  minor-latin;mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
  mso-ansi-language:EN-US"><span style="mso-list:Ignore">4.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span><!--[endif]--><span lang="EN-US" style="mso-ansi-language:EN-US">The <span class="GramE">general
  public</span> are not required to create an account for searching volcanos<o:p></o:p></span></p>
  </td>
  <td width="113" valign="top" style="width:3.0cm;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:4.25pt">
  <p class="MsoNormal">Functional<o:p></o:p></p>
  </td>
  <td width="66" valign="top" style="width:49.65pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
 ...
 <tr style="mso-yfti-irow:4;height:88.05pt">
  <td width="66" valign="top" style="width:49.15pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:88.05pt">
  <p class="MsoNormal">US04<o:p></o:p></p>
  </td>
  <td width="378" valign="top" style="width:10.0cm;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:88.05pt">
  <p class="MsoNormal">As a geologist I want to receive the notifications when the
  subscribed volcano has new observations so that I can update my research with
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:88.05pt">
  <p class="MsoListParagraphCxSpFirst" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l3 level1 lfo3"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin"><span style="mso-list:Ignore">1.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;
  </span></span></span><!--[endif]-->Be notified when someone share observations according
  to preferences<o:p></o:p></p>
  <p class="MsoListParagraphCxSpLast" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l3 level1 lfo3"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin"><span style="mso-list:Ignore">2.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;
  </span></span></span><!--[endif]-->Get notified within 5 minutes<o:p></o:p></p>
  </td>
  <td width="113" valign="top" style="width:3.0cm;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
 ...
 <tr style="mso-yfti-irow:5;height:103.2pt">
  <td width="66" valign="top" style="width:49.15pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:103.2pt">
  <p class="MsoNormal">US05<o:p></o:p></p>
  </td>
  <td width="378" valign="top" style="width:10.0cm;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:103.2pt">
  <p class="MsoNormal">As a geologist worked in UCL, I want to post my research
  and predictions so that I can share it with other researchers over the world.<o:p></o:p></p>
  </td>
  <td width="387" valign="top" style="width:290.55pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:103.2pt">
  <p class="MsoListParagraphCxSpFirst" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l8 level1 lfo1"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin"><span style="mso-list:Ignore">1.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;
  </span></span></span><!--[endif]-->Connected and verified with education/research
  institutions account management API<o:p></o:p></p>
  <p class="MsoListParagraphCxSpMiddle" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l8 level1 lfo1"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin"><span style="mso-list:Ignore">2.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;
  </span></span></span><!--[endif]-->Support login through SSO (Single Sign-On)<o:p></o:p></p>
  <p class="MsoListParagraphCxSpMiddle" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l8 level1 lfo1"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin"><span style="mso-list:Ignore">3.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;
  </span></span></span><!--[endif]-->Support sending pictures, videos, and texts<o:p></o:p></p>
  <p class="MsoListParagraphCxSpLast" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l4 level1 lfo4"><!--[if !supportLists]--><span lang="EN-US" style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:
  minor-latin;mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
  mso-ansi-language:EN-US"><span style="mso-list:Ignore">5.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span><!--[endif]-->The
  shared research should be recorded and trackable<span lang="EN-US" style="mso-ansi-language:EN-US"><o:p></o:p></span></p>
  </td>
  <td width="113" valign="top" style="width:3.0cm;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
 ...
 <tr style="mso-yfti-irow:6;height:111.3pt">
  <td width="66" valign="top" style="width:49.15pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:111.3pt">
  <p class="MsoNormal">US06<o:p></o:p></p>
  </td>
  <td width="378" valign="top" style="width:10.0cm;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:111.3pt">
  <p class="MsoNormal">As the residents, I want to create an account so that I
  can receive alert and change my contact details.<o:p></o:p></p>
  </td>
  <td width="387" valign="top" style="width:290.55pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:111.3pt">
  <p class="MsoListParagraphCxSpFirst" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l9 level1 lfo6"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin"><span style="mso-list:Ignore">1.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;
  </span></span></span><!--[endif]-->Contact details contain phone number, email address,
  resident address, <span class="GramE">password</span> and name<o:p></o:p></p>
  <p class="MsoListParagraphCxSpMiddle" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l9 level1 lfo6"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin"><span style="mso-list:Ignore">2.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;
  </span></span></span><!--[endif]-->One resident can subscribe multiple volcano
  alerts<o:p></o:p></p>
  <p class="MsoListParagraphCxSpMiddle" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l9 level1 lfo6"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin"><span style="mso-list:Ignore">3.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;
  </span></span></span><!--[endif]-->Data storage and use must comply with data
  protection law<o:p></o:p></p>
  <p class="MsoListParagraphCxSpLast" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l8 level1 lfo1"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin"><span style="mso-list:Ignore">4.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;
  </span></span></span><!--[endif]-->Send alerts to residents within 1 second<o:p></o:p></p>
  </td>
  <td width="113" valign="top" style="width:3.0cm;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
 ...
 <tr style="mso-yfti-irow:7;height:17.65pt">
  ...
  <p class="MsoNormal">US07<o:p></o:p></p>
  </td>
  <td width="378" valign="top" style="width:10.0cm;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:17.65pt">
  <p class="MsoNormal">As the residents lived near a volcano, I want to be able
  to submit a monitoring report so that I can share some observations about the
  volcanos.<o:p></o:p></p>
  </td>
  <td width="387" valign="top" style="width:290.55pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:17.65pt">
  <p class="MsoListParagraphCxSpFirst" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l6 level1 lfo5"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin"><span style="mso-list:Ignore">1.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;
  </span></span></span><!--[endif]-->Support sending pictures, videos, and texts<o:p></o:p></p>
  <p class="MsoListParagraphCxSpMiddle" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l6 level1 lfo5"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin"><span style="mso-list:Ignore">2.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;
  </span></span></span><!--[endif]-->The user’s resident address should be verified<o:p></o:p></p>
  <p class="MsoListParagraphCxSpLast" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l6 level1 lfo5"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin"><span style="mso-list:Ignore">3.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;
  </span></span></span><!--[endif]-->The submitted report should be recorded and
  trackable<o:p></o:p></p>
  </td>
  <td width="113" valign="top" style="width:3.0cm;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
 ...
 <tr style="mso-yfti-irow:8;height:128.55pt">
  <td width="66" valign="top" style="width:49.15pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:128.55pt">
  <p class="MsoNormal">US08<o:p></o:p></p>
  </td>
  <td width="378" valign="top" style="width:10.0cm;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:128.55pt">
  <p class="MsoNormal">As a geologist I want to tailor and save my preferences of
  types of charts so that I can save time on preparing and visualizing data.<o:p></o:p></p>
  </td>
  <td width="387" valign="top" style="width:290.55pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:128.55pt">
  <p class="MsoListParagraphCxSpFirst" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l0 level1 lfo7"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin"><span style="mso-list:Ignore">1.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;
  </span></span></span><!--[endif]-->Display options of charts<o:p></o:p></p>
  <p class="MsoListParagraphCxSpMiddle" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l0 level1 lfo7"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin"><span style="mso-list:Ignore">2.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;
  </span></span></span><!--[endif]-->The elements of charts like axis label and
  caption are displayed and editable<o:p></o:p></p>
  <p class="MsoListParagraphCxSpMiddle" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l0 level1 lfo7"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin"><span style="mso-list:Ignore">3.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;
  </span></span></span><!--[endif]-->Data like eruption period and date can be
  chosen by the users<o:p></o:p></p>
  <p class="MsoListParagraphCxSpMiddle" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l0 level1 lfo7"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin"><span style="mso-list:Ignore">4.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;
  </span></span></span><!--[endif]-->Create charts from browsers on PC or laptop<o:p></o:p></p>
  <p class="MsoListParagraphCxSpLast" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l0 level1 lfo7"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin"><span style="mso-list:Ignore">5.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;
  </span></span></span><!--[endif]-->Data is retrieved from volcano data repository
  using an authenticated API.<o:p></o:p></p>
  </td>
  <td width="113" valign="top" style="width:3.0cm;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
 ...
 <tr style="mso-yfti-irow:9;height:103.2pt">
  <td width="66" valign="top" style="width:49.15pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:103.2pt">
  <p class="MsoNormal">US09<o:p></o:p></p>
  </td>
  <td width="378" valign="top" style="width:10.0cm;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:103.2pt">
  <p class="MsoNormal">As a geologist, I want to have download functionality so
  that I can use the data and charts for further analysis.<o:p></o:p></p>
  </td>
  <td width="387" valign="top" style="width:290.55pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:103.2pt">
  <p class="MsoListParagraphCxSpFirst" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l1 level1 lfo9"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin"><span style="mso-list:Ignore">1.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;
  </span></span></span><!--[endif]-->Download the data as xlsx or csv format<o:p></o:p></p>
  <p class="MsoListParagraphCxSpMiddle" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l1 level1 lfo9"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin"><span style="mso-list:Ignore">2.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;
  </span></span></span><!--[endif]-->Download the chart as jpg or pdf format<o:p></o:p></p>
  <p class="MsoListParagraphCxSpMiddle" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l1 level1 lfo9"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin"><span style="mso-list:Ignore">3.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;
  </span></span></span><!--[endif]-->Finish the downloading within maximum 60 minutes
  depends on the size of data and charts.<o:p></o:p></p>
  <p class="MsoListParagraphCxSpLast" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l1 level1 lfo9"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin"><span style="mso-list:Ignore">4.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;
  </span></span></span><!--[endif]-->Data is retrieved from volcano data repository
 ...
 <tr style="mso-yfti-irow:10;mso-yfti-lastrow:yes;height:69.15pt">
  <td width="66" valign="top" style="width:49.15pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:69.15pt">
  <p class="MsoNormal">US10<o:p></o:p></p>
  </td>
  <td width="378" valign="top" style="width:10.0cm;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:69.15pt">
  <p class="MsoNormal">As a global geologist, I want to have translation
  functionality so that I can understand the observations from the residents.<o:p></o:p></p>
  </td>
  <td width="387" valign="top" style="width:290.55pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:69.15pt">
  <p class="MsoListParagraphCxSpFirst" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l2 level1 lfo10"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin"><span style="mso-list:Ignore">1.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;
  </span></span></span><!--[endif]-->Connected with Google or Microsoft translation
  API<o:p></o:p></p>
  <p class="MsoListParagraphCxSpLast" style="margin-bottom:0cm;mso-add-space:
  auto;text-indent:-18.0pt;line-height:normal;mso-list:l2 level1 lfo10"><!--[if !supportLists]--><span style="mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;
  mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin"><span style="mso-list:Ignore">2.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;
  </span></span></span><!--[endif]-->Return the translation results within 5
  seconds<o:p></o:p></p>
  </td>
  <td width="113" valign="top" style="width:3.0cm;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
...
![workflow](https://github.com/ucl-comp0035/coursework-1-Longfei-CLF/blob/46cdeb69d0934a162dc7f800becea8b6fc56fa4f/images/Workflow.png)
